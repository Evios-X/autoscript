...
cd /usr/bin
wget https://raw.githubusercontent.com/Evios-X/autoscript/main/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/Evios-X/autoscript/main/bot/kyt.zip
unzip kyt.zip
